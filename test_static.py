...
def test_static():
	...
	try:
		...
		data = "testdata"
		print("[1]sending POST request to http://localhost:8080/html/test, expecting 200")
		response = requests.post("http://localhost:8080/html/test", data=data)
		assert response.status_code == 200, f"[1] Failed to get 200 response. {response.status_code}"
		print("[2]sending GET request to http://localhost:8080/html/test, expecting 200")
		response = requests.get("http://localhost:8080/html/test")
		...
		print("[4]sending DELETE request to http://localhost:8080/html/test, expecting 200")
		response = requests.delete("http://localhost:8080/html/test")
		assert response.status_code == 200, f"[4] Failed to get 200 response. {response.status_code}"
		print("[5]sending GET request to http://localhost:8080/html/test, expecting 404")
		response = requests.get("http://localhost:8080/html/test")
		...
		print("[6]sending too large POST request to http://localhost:8080/html/test, expecting 413")
		data = "a" * 10000
		response = requests.post("http://localhost:8080/html/test", data=data)
		assert response.status_code == 413, f"[6] Failed to get 413 response. {response.status_code}"
		print("[7]sending GET request with too long uri to http://localhost:8080/html/test, expecting 414")
		response = requests.get("http://localhost:8080/html/test" + "/a" * 10000)
